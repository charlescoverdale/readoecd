test_that("get_oecd_unemployment() returns correct structure", {
  ...
  df <- expect_oecd(get_oecd_unemployment(c("AUS", "GBR"), start_year = 2020))
...
test_that("get_oecd_unemployment() returns correct countries", {
  ...
  df <- expect_oecd(get_oecd_unemployment(c("AUS", "GBR"), start_year = 2023))
...
test_that("get_oecd_unemployment() respects start_year", {
  ...
  df <- expect_oecd(get_oecd_unemployment("AUS", start_year = 2022))
...
test_that("get_oecd_unemployment() returns plausible values", {
  ...
  df <- expect_oecd(get_oecd_unemployment(c("AUS", "GBR", "USA"), start_year = 2023))
...
test_that("get_oecd_unemployment() series and unit are consistent", {
  ...
  df <- expect_oecd(get_oecd_unemployment("AUS", start_year = 2024))
...
test_that("get_oecd_unemployment() caches results", {
  ...
  df1 <- expect_oecd(get_oecd_unemployment("AUS", start_year = 2023))
  df2 <- expect_oecd(get_oecd_unemployment("AUS", start_year = 2023))
