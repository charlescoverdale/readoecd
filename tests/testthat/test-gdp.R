...
test_that("get_oecd_gdp() returns correct structure", {
  ...
  df <- expect_oecd(get_oecd_gdp(c("AUS", "GBR"), start_year = 2015))
...
test_that("get_oecd_gdp() returns correct countries", {
  ...
  df <- expect_oecd(get_oecd_gdp(c("AUS", "GBR"), start_year = 2018))
...
test_that("get_oecd_gdp() respects start_year", {
  ...
  df <- expect_oecd(get_oecd_gdp("AUS", start_year = 2010))
...
test_that("get_oecd_gdp() returns plausible values", {
  ...
  df <- expect_oecd(get_oecd_gdp("AUS", start_year = 2020))
